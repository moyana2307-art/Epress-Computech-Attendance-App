...
export function StatsCard({ icon, label, value, trend, color, delay = 0, subtitle }: StatsCardProps) {
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-xl bg-white dark:bg-gray-800 border border-border-light p-5 shadow-sm hover:shadow-md hover:border-primary/10 dark:hover:border-primary/20 transition-all duration-300 group"
    >

  ...
  return (
    <>
      <button
        ...
        className="fixed top-4 left-4 z-40 lg:hidden p-2 rounded-xl bg-white border border-border-light shadow-sm"
      >
      ...
      <aside
        className={cn(
          'fixed top-0 left-0 z-30 h-screen bg-sidebar border-r border-border-light flex flex-col transition-all duration-300',
          collapsed ? 'w-[72px]' : 'w-64',
          mobileOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
        )}
      >
        <div className={cn('flex items-center h-16 px-4 border-b border-border-light', collapsed && 'justify-center')}>
        ...
        <div className={cn('px-4 py-3 border-b border-border-light', collapsed && 'px-2')}>
          <div className={cn('flex items-center gap-2', collapsed && 'justify-center')}>
            <div className="w-7 h-7 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white text-xs font-bold font-heading">
